...
\pagebreak
\tableofcontents
\include{./articles/01-name} % FC RENAME
\include{./articles/02-objectives} % FC
\include{./articles/03-membership} % Needs method of removal, TODO in there
\include{./articles/04-officers} % Add GPA requirement to officers clarify full semester stuco rep
\include{./articles/05-advisors} % FC
\include{./articles/06-committees} % Add Comp, ACM Women
\include{./articles/07-dues} % Fix, remove officer section
\include{./articles/08-meetings} % TODO
\include{./articles/09-rules} % FC
\include{./articles/10-constitution} % TODO
